...
class AdminEmergencyReportForm(EmergencyReportForm):
    """Form for admins to manage emergency reports, including reporter assignment."""
    
    class Meta(EmergencyReportForm.Meta):
        fields = ['reported_by', 'emergency_type', 'status', 'location', 'latitude', 'longitude', 'description']
        widgets = {
            **EmergencyReportForm.Meta.widgets,
